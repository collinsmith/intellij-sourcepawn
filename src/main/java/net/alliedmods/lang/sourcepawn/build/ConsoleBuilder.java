...
import net.alliedmods.lang.sourcepawn.action.RerunAction;
  ...
  public Process build() {
    ...
    try {
      ...
      Messages.showErrorDialog(project,
          SpBundle.message("sp.error.compiler.process.msg", buildConfiguration, e.getMessage()),
          SpBundle.message("sp.error.compiler.process.title"));
