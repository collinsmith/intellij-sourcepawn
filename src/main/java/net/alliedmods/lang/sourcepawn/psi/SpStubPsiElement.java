...
public abstract class SpStubPsiElement<StubT extends StubElement>
    extends StubBasedPsiElementBase<StubT>
    implements StubBasedPsiElement<StubT> {

  private static final Logger LOG = Logger.getInstance("#net.alliedmods.lang.sourcepawn.psi.SpStubPsiElement");

  public SpStubPsiElement(@NotNull StubT stub, @NotNull IStubElementType type) {
    super(stub, type);
  }

  public SpStubPsiElement(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  public PsiElement addBefore(@NotNull PsiElement element, PsiElement anchor) throws
      IncorrectOperationException {
    CheckUtil.checkWritable(this);
    TreeElement elementCopy = ChangeUtil.copyToElement(element);
    calcTreeElement().addInternal(elementCopy, elementCopy, SourceTreeToPsiMap.psiElementToTree
        (anchor), Boolean.TRUE);
    elementCopy = ChangeUtil.decodeInformation(elementCopy);
    return SourceTreeToPsiMap.treeElementToPsi(elementCopy);
  }
  ...
  @Override
  public PsiElement addAfter(@NotNull PsiElement element, @Nullable PsiElement anchor) throws
      IncorrectOperationException {
    CheckUtil.checkWritable(this);
    TreeElement elementCopy = ChangeUtil.copyToElement(element);
    calcTreeElement().addInternal(elementCopy, elementCopy, SourceTreeToPsiMap.psiElementToTree
  ...
  @Override
  public void deleteChildRange(PsiElement first, PsiElement last) throws
      IncorrectOperationException {
    CheckUtil.checkWritable(this);
    if (first == null) {
