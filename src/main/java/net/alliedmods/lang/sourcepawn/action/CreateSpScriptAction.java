...
public class CreateSpScriptAction extends CreateFileFromTemplateAction implements DumbAware {

  @NonNls
  private static final String NEW_SOURCEMOD_PLUGIN = "New SourceMod Plugin";

  @NonNls
  private static final String EMPTY_MODULE_TEMPLATE = "SourceMod Plugin";

  public CreateSpScriptAction() {
    super(NEW_SOURCEMOD_PLUGIN, "", SpIcons.FILE);
  }

  protected CreateSpScriptAction(String text, String description, Icon icon) {
    super(text, description, icon);
  }

  @Override
  protected void buildDialog(Project project, PsiDirectory psiDirectory, CreateFileFromTemplateDialog.Builder builder) {
    builder.setTitle(NEW_SOURCEMOD_PLUGIN)
  ...
  public static List<String> getPathFromSourceRoot(Project project, VirtualFile file) {
  ...
  public enum ClassNameValidator implements InputValidatorEx {
    ...
    private final Pattern VALID_MODULE_NAME_REGEX = Pattern.compile("[A-z_.0-9]+");
    ...
    public String getErrorText(final String inputString) {
      ...
      return String.format("\'%s\' is not a valid SourcePawn file name.", inputString);
    }
