...
public class SpStringLiteralLexer extends LexerBase implements PragmaChangeListener {

  private static final Logger LOG = Logger.getInstance("#net.alliedmods.lang.sourcepawn.lexer.SpStringLiteralLexer");
  ...
  public SpStringLiteralLexer(char quoteChar, @NotNull IElementType originalToken) {
    this(quoteChar, originalToken, 0);
  }

  public SpStringLiteralLexer(char quoteChar, @NotNull IElementType originalToken, int startOffset) {
  ...
  public IElementType getTokenType() {
    ...
    switch (ch) {
      case '\r':case '\n':
        return SpTokenTypes.ESCAPING_SLASH;
      case '"':case '\'':case '%':
        return StringEscapesTokenTypes.VALID_STRING_ESCAPE_TOKEN;
